...
CREATE TABLE IF NOT EXISTS bill_future_settle_basic_info (
    ...
    broker          VARCHAR(32)     NOT NULL                COMMENT '券商',
...
CREATE TABLE IF NOT EXISTS bill_future_settle_capital_info (
  ...
  COMMENT='期货对账单-资金状况表（期货/期权/证券现货统一宽表）';
